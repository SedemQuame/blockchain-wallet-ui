...
function ViewJobs() {
    ...
    let jobs = [
        {
            image: "https://diversitymbamagazine.com/wp-content/uploads/2020/08/JP-Morgan-Chase-Logo.png",
            ...
            experiences: [
                ...
                "Credit SME or SME for another complex asset class.",
        ...
        {
            image: "https://pbs.twimg.com/profile_images/927911317498941440/43rkL2cB_400x400.jpg",
                ...
                <div className="container">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Browse Jobs - List Layout</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div className="container my-4">
                <div className="row">
                    ...
                    <div className="col-12 col-md-3 border-start">
                        ...
                        <form action="">
                            <div className="mb-3">
                                <label htmlFor="exampleFormControlInput1" className="form-label">Keywords</label>
