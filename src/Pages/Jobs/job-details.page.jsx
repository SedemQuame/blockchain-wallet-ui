...
function JobDetails(props) {
  ...
  return (
    <>
        ...
        <div className="row">
          <div className="col-12 col-md-9">
            <div>
              ...
              <hr />
              <p className="list-header text-capitalize">
                <strong>What do we offer?</strong>
              </p>
              <ul style={{ listStyle: "inside" }} className="job-item-list">
                {data.companyOffer.map((offer) => (
                  <li className="job-information">{offer}</li>
                ))}
              </ul>
              ...
              <ul style={{ listStyle: "inside" }} className="job-item-list">
                {data.responsibilities.map((responsibility) => (
                  <li className="job-information">{responsibility}</li>
                ))}
              </ul>
              ...
              <ul style={{ listStyle: "inside" }} className="job-item-list">
                {data.essentialSkills.map((skill) => (
                  <li className="job-information">{skill}</li>
                ))}
              </ul>
              ...
              <ul style={{ listStyle: "inside" }} className="job-item-list">
                {data.desirableSkills.map((skill) => (
                  <li className="job-information">{skill}</li>
                ))}
              </ul>

              <p className="list-header text-capitalize">
                <strong>highly Desirable Experience</strong>
              </p>
              <ul style={{ listStyle: "inside" }} className="job-item-list">
                {data.experiences.map((experience) => (
                  <li className="job-information">{experience}</li>
                ))}
              </ul>

              <p className="list-header text-capitalize">
                <strong>About {data.company}</strong>
              </p>
          ...
          <div className="col-12 col-md-3">
            <div className="card text-center p-3 mb-4">
              <div className="card-body">
                ...
                <p className="card-subtitle mb-2 text-muted">$100,000</p>
                <p className="card-subtitle mb-2 text-muted">Full Time Role</p>
                ...
                <div className="d-flex gap-4">
                  ...
                  <div className="text-left">
                    <p className="card-subtitle mb-2 text-muted">
                      24 Open positions at his company
                    </p>
      ...
      <div className="text-left bg-light rounded-3">
        <div className="container py-5 d-grid gap-2">
